 ...
 *                      $ref: '#/components/schemas/NoFound'
 */
router.get('/photos/:id', user_controller_1.getUserPhotos);
/**
 * @swagger
 * /users/posts:
 *  get:
 ...
 *                          $ref: '#/components/schemas/NoFound'
 */
router.get('/posts', user_controller_1.getUserPosts);
/**
 * @swagger
 * /users/{id}:
 *  patch:
 ...
 *                          $ref: '#/components/schemas/NoFound'
 */
router.patch('/:id', user_controller_1.patchUser);
/**
 * @swagger
 * /users/photos/{id}:
 *  patch:
 ...
 *                          $ref: '#/components/schemas/NoFound'
 */
router.patch('/photos/:id', user_controller_1.patchPhotos);
/**
 * @swagger
 * /users/post/{id}:
 *  patch:
...
*                           $ref: '#/components/schemas/NoFound'
 */
router.patch('/posts/:id', user_controller_1.patchPost);
/**
 * @swagger
 * /users/{id}:
 *  delete:
 ...
 *                          $ref: '#/components/schemas/NoFound'
 */
router.delete('/photos/:id', user_controller_1.deletePhotos);
/**
 * @swagger
 * /users/post/{id}:
 *  delete:
 ...
 *                          $ref: '#/components/schemas/NoFound'
 */
router.delete('/posts/:id', user_controller_1.deletePost);
